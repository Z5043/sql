...
FROM
 ...
 , KDW.DWD_ITEM_W  R_ITEM_W,
  ...
  AND  zs_i.HSZ  =  '064'
  AND  zs_i.STATE  =  1
 AND ( (zs_i.item_ts  NOT IN  ('Т06', 'Т75', 'Т106' , 'Т80')  AND  zso.ABC0  IN  ('A')) or (zs_i.item_ts = 'Т45' and zso.ABC0 in ('A','B','C')) or (zs_i.item_ts = 'Т80' and zso.ABC0 in ('A') and (zs_item_g.ITEM_G2 IN ( '1828' , '1829') or  zs_item_g.ITEM_G4 in ('18260705')) ))
