 ...
 SELECT
  ...
  mvw_goods.HSZ ХСЗ,
  main_v.VENDOR_NUM Код_поставщика_неакт,
  main_v.VENDOR_NAME Название_поставщика_неакт,
  main_v.LEAD_TIME СП_неакт,
  main_v.STOCK_CONTROL ЧКЗ_неакт,
  main_v.VEND_PARENT_NUM Код_факт_поставщика_неакт,
  main_v.VEND_PARENT_NAME Название_факт_поставщика_неакт,
...
Select 
  ...
  t1.СОХ,
  t1.ХСЗ,
  t1.Код_поставщика_неакт,
  t1.Название_поставщика_неакт,
  t1.Код_факт_поставщика_неакт,
  t1.Название_факт_поставщика_неакт,
  t2.Название_КМ,
  ...
  t2.Период_запаса_С,
  art3.Дата_смены,
  art3.новая_категория,
  art3.старая_категория
  from t1, t2, art3
  where t1.Артикул=t2.Артикул(+)
  and t1.Артикул=art3.Артикул(+)