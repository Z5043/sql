...
FROM
  ...
  ,
    ...
    FROM
      KDW.DWD_CALENDAR cal
    WHERE
      ( cal.CAL_DATE BETWEEN TO_DATE(@Prompt('011. Дата начала периода','A',,mono,free), 'DD.MM.YYYY')
                         AND TO_DATE(@Prompt('012. Дата окончания периода','A',,mono,free), 'DD.MM.YYYY') )
    )
  ,
    vt_cal_01mmyyyy AS
    (
  ...
  ,
    ...
    FROM
      KDW.DWD_CALENDAR cal
    WHERE
      ( cal.CAL_DATE IN TO_DATE(@Prompt('13_1. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
    )
  ,
  ...
  ,
    ...
    FROM
      KDW.DWD_CALENDAR cal
    WHERE
      ( cal.CAL_DATE IN TO_DATE(@Prompt('13_2. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
    )
  ,
  ...
  ,
    ...
    FROM
      KDW.DWD_CALENDAR cal
    WHERE
      ( cal.CAL_DATE IN TO_DATE(@Prompt('13_3. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
    )
  ,
  ...
  ,
    ...
    FROM
      KDW.DWD_CALENDAR cal
    WHERE
      ( cal.CAL_DATE IN TO_DATE(@Prompt('13_4. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
    )
  ,
  ...
  ,
    ...
    FROM
      KDW.DWD_CALENDAR cal
    WHERE
      ( cal.CAL_DATE IN TO_DATE(@Prompt('13_5. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
    )
  ,
  ...
  ,
    ...
    FROM
      KDW.DWD_WHSE mvw_w
    WHERE
      ( mvw_w.WHSE_CODE IN @Prompt('21. Код склада','A',{'все', '060', '00D', '0QR', '0D0', '0Q0', '00J', '00G', '0C0', '1DR', '1LE', '1DW', '1DH', '1DE', '1DQ', '092', 'CKL', '0MX', '05H', '1L5', '02V', '0B3', '01R', '0K3', '01B', '02M', '04P'},multi,free)
  ...
  ,
    ...
    WHERE
          ( d.DIV_TYPE = '2' )
      AND ( d.IS_CURRENT = 'Y' )
      AND ( d.DIV_CODE IN @Prompt('31. ТР','A',{'все', 'Т44', 'Т45', 'Т46', 'Т50', 'Т51', 'Т54', 'Т55', 'Т56', 'Т57', 'Т58', 'Т59', 'Т78', 'Т79', 'Т80', 'Т81', 'Т82', 'Т83', 'Т84', 'Т85', 'Т86', 'Т87', 'Т91', 'Т92', 'Т93', 'Т33', 'Т32', 'Т21', 'Т90', 'Т94', 'Т96', 'Т97', 'Т98', 'Т99', 'Т95', 'Т100'},multi,free)
  ...
  ,
    ...
    WHERE
      ...
      AND ( g.STATE IN @Prompt('36. Состояние товара','A',{'все', '1', '2'},multi,free)
           OR 'все' IN @Prompt('36. Состояние товара','A',{'все', '1', '2'},multi,free) )
      
      AND ( g.IND_CATEGORY IN @Prompt('34. Признак категория','A',{'все', 'D', 'E', 'G', 'H', 'J', 'K', 'L', 'P', 'Q', 'R', 'S', 'U', 'V', 'W', 'Z', 'А', 'В', 'И', 'Л', 'М', 'Н', 'О', 'П', 'С', 'Т', 'У'},multi,free)
                  OR 'все' IN @Prompt('34. Признак категория','A',{'все', 'D', 'E', 'G', 'H', 'J', 'K', 'L', 'P', 'Q', 'R', 'S', 'U', 'V', 'W', 'Z', 'А', 'В', 'И', 'Л', 'М', 'Н', 'О', 'П', 'С', 'Т', 'У'},multi,free) )
      
      AND ( g.HSZ IN @Prompt('35. ХСЗ','A',{'все', '064', 'Т33', 'Т10'},multi,free)
         OR 'все' IN @Prompt('35. ХСЗ','A',{'все', '064', 'Т33', 'Т10'},multi,free) )
      
      AND ( g.ITEM_NUM IN @Prompt('37. Артикул','A',{'все', '120', '32033'},multi,free)
  ...
  ,
    ...
    WHERE
          ( g_item_k1.PR_NUM = @Prompt('41. Признак1','A',{'3139', '3655', '6036'},mono,free) )
  ...
  ,
    ...
    WHERE
      ( ITEM_R.ID_DATE BETWEEN ( SELECT kdw.getDateID(TO_DATE(@Prompt('11. Дата начала периода','A',,mono,free), 'DD.MM.YYYY')) FROM dual )
                           AND ( SELECT kdw.getDateID(TO_DATE(@Prompt('12. Дата окончания периода','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
    )
  ,
    vt_tov_zap AS
    (
  ...
  ,
    ...
    FROM
      KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                              ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
    WHERE
      ( ITEM_R.ID_DATE BETWEEN ( SELECT kdw.getDateID(TO_DATE(@Prompt('011. Дата начала периода','A',,mono,free), 'DD.MM.YYYY')) FROM dual )
                           AND ( SELECT kdw.getDateID(TO_DATE(@Prompt('012. Дата окончания периода','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
    )
  ,
    vt_tov_zap_0 AS
    (
    ...
    FROM
      ...
      FROM
        KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                                ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
      WHERE
        ( ITEM_R.ID_DATE = ( SELECT kdw.getDateID(TO_DATE(@Prompt('13_1. Дата отчёта','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
      ) item_r JOIN vt_catalog_tovara_kdw_other_16
                 ON ( ITEM_R.ITEM_NUM = vt_catalog_tovara_kdw_other_16.Артикул )
    GROUP BY
      vt_catalog_tovara_kdw_other_16.Артикул
    ...
    FROM
      ...
      FROM
        KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                                ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
      WHERE
        ( ITEM_R.ID_DATE = ( SELECT kdw.getDateID(TO_DATE(@Prompt('13_2. Дата отчёта','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
      ) item_r JOIN vt_catalog_tovara_kdw_other_16
                 ON ( ITEM_R.ITEM_NUM = vt_catalog_tovara_kdw_other_16.Артикул )
    GROUP BY
      vt_catalog_tovara_kdw_other_16.Артикул
    ...
    FROM
      ...
      FROM
        KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                                ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
      WHERE
        ( ITEM_R.ID_DATE = ( SELECT kdw.getDateID(TO_DATE(@Prompt('13_3. Дата отчёта','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
      ) item_r JOIN vt_catalog_tovara_kdw_other_16
                 ON ( ITEM_R.ITEM_NUM = vt_catalog_tovara_kdw_other_16.Артикул )
    GROUP BY
      vt_catalog_tovara_kdw_other_16.Артикул
    ...
    FROM
      ...
      FROM
        KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                                ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
      WHERE
        ( ITEM_R.ID_DATE = ( SELECT kdw.getDateID(TO_DATE(@Prompt('13_4. Дата отчёта','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
      ) item_r JOIN vt_catalog_tovara_kdw_other_16
                 ON ( ITEM_R.ITEM_NUM = vt_catalog_tovara_kdw_other_16.Артикул )
    GROUP BY
      vt_catalog_tovara_kdw_other_16.Артикул
    ...
    FROM
      ...
      FROM
        KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                                ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
      WHERE
        ( ITEM_R.ID_DATE = ( SELECT kdw.getDateID(TO_DATE(@Prompt('13_5. Дата отчёта','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
      ) item_r JOIN vt_catalog_tovara_kdw_other_16
                 ON ( ITEM_R.ITEM_NUM = vt_catalog_tovara_kdw_other_16.Артикул )
    GROUP BY
      vt_catalog_tovara_kdw_other_16.Артикул
    ...
    FROM
      ...
      FROM
        KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                                ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
      WHERE
        ( ITEM_R.ID_DATE = ( SELECT kdw.getDateID(TO_DATE(@Prompt('13_6. Дата отчёта','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
      ) item_r JOIN vt_catalog_tovara_kdw_other_16
                 ON ( ITEM_R.ITEM_NUM = vt_catalog_tovara_kdw_other_16.Артикул )
    GROUP BY
      vt_catalog_tovara_kdw_other_16.Артикул
    ...
    FROM
      ...
      FROM
        KDW.DWF_ITEM_R ITEM_R JOIN vt_whse_code
                                ON ( ITEM_R.ID_WHSE = vt_whse_code.ID_Кода_склада )
      WHERE
        ( ITEM_R.ID_DATE = ( SELECT kdw.getDateID(TO_DATE(@Prompt('13_7. Дата отчёта','A',,mono,free), 'DD.MM.YYYY')) FROM dual ) )
      ) item_r JOIN vt_catalog_tovara_kdw_other_16
                 ON ( ITEM_R.ITEM_NUM = vt_catalog_tovara_kdw_other_16.Артикул )
    GROUP BY
      vt_catalog_tovara_kdw_other_16.Артикул
  ...
  ,
    ...
    WHERE
          ( i_d_v2.trans_date BETWEEN TO_DATE(@Prompt('11. Дата начала периода','A',,mono,free), 'DD.MM.YYYY')
                                  AND TO_DATE(@Prompt('12. Дата окончания периода','A',,mono,free), 'DD.MM.YYYY') )
      AND (
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_cal_period_rd_count_0
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date BETWEEN TO_DATE(@Prompt('011. Дата начала периода','A',,mono,free), 'DD.MM.YYYY')
                                  AND TO_DATE(@Prompt('012. Дата окончания периода','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_whse_code
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date = TO_DATE(@Prompt('13_1. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
          /* 2. ВП на склады региона Москва типа 3,4  */
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_whse_code
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date = TO_DATE(@Prompt('13_2. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
          /* 2. ВП на склады региона Москва типа 3,4  */
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_whse_code
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date = TO_DATE(@Prompt('13_3. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
          /* 2. ВП на склады региона Москва типа 3,4  */
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_whse_code
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date = TO_DATE(@Prompt('13_4. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
          /* 2. ВП на склады региона Москва типа 3,4  */
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_whse_code
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date = TO_DATE(@Prompt('13_5. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
          /* 2. ВП на склады региона Москва типа 3,4  */
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_whse_code
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date = TO_DATE(@Prompt('13_6. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
          /* 2. ВП на склады региона Москва типа 3,4  */
...
,
    ...
    FROM
      KDW.DWE_ITEM_DIV_M2 i_d_v2 JOIN vt_whse_code
                      ...
                      LEFT OUTER JOIN KDW.DWE_WHSE WHSE_CUST
                                   ON ( i_d_v2.CUST_NUM = WHSE_CUST.WHSE_CODE )
    WHERE
          ( i_d_v2.trans_date = TO_DATE(@Prompt('13_7. Дата отчёта','A',,mono,free), 'DD.MM.YYYY') )
      AND (
          /* 1. Клиентская отгрузка */
          i_d_v2.MOVE_TYPE IN (4,5,9) OR i_d_v2.CAUSE_CODE = '0060' AND i_d_v2.TRANS_DATE < TO_DATE('01.06.2010','DD.MM.YYYY') OR
          /* 2. ВП на склады региона Москва типа 3,4  */
  ...
  SELECT
    ...
    vt_catalog_tovara_kdw_other_16.МТП,
    vt_catalog_tovara_kdw_other_16.Форма_снабжения,
...
a.spec_id,
 a.spec_date,
  ...
  CEIL((TO_CHAR(a.date_r , 'DDD')+TO_CHAR(TRUNC(a.date_r , 'YEAR'), 'D')-1)/7) week_number,
  CEIL((TO_CHAR(a.date_r , 'DDD')+TO_CHAR(TRUNC(a.date_r , 'YEAR'), 'D')-1)/7)+1 week_number2,
  
  CASE WHEN CEIL((TO_CHAR(a.date_r , 'DDD')+TO_CHAR(TRUNC(a.date_r , 'YEAR'), 'D')-1)/7) < CEIL((TO_CHAR(sysdate , 'DDD')+TO_CHAR(TRUNC(sysdate , 'YEAR'), 'D')-1)/7) then (a.qty * b.VOLUME)/1000000 else 0 end as В_пути_опаздываетМ,
  
  CASE WHEN CEIL((TO_CHAR(a.date_r , 'DDD')+TO_CHAR(TRUNC(a.date_r , 'YEAR'), 'D')-1)/7) = CEIL((TO_CHAR(sysdate , 'DDD')+TO_CHAR(TRUNC(sysdate , 'YEAR'), 'D')-1)/7) then (a.qty * b.VOLUME)/1000000 else 0 end -  CASE WHEN a.lev=4 and a.sts IN ('3', '4')  then (a.qty * b.VOLUME)/1000000 else 0 end as В_пути_Эта_неделяМ,
  
  CASE WHEN CEIL((TO_CHAR(a.date_r , 'DDD')+TO_CHAR(TRUNC(a.date_r , 'YEAR'), 'D')-1)/7) = CEIL((TO_CHAR(sysdate , 'DDD')+TO_CHAR(TRUNC(sysdate , 'YEAR'), 'D')-1)/7)+1 then (a.qty * b.VOLUME)/1000000 else 0 end as В_пути_Эта_След_НедМ,

  CASE WHEN CEIL((TO_CHAR(a.date_r , 'DDD')+TO_CHAR(TRUNC(a.date_r , 'YEAR'), 'D')-1)/7) = CEIL((TO_CHAR(sysdate , 'DDD')+TO_CHAR(TRUNC(sysdate , 'YEAR'), 'D')-1)/7)+2 then (a.qty * b.VOLUME)/1000000 else 0 end as В_пути_Эта_Через_НедМ
