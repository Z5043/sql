...
FROM
 ...
 , KDW.DWD_ITEM_W  R_ITEM_W,
  ...
  AND  zs_i.HSZ  =  '064'
  AND  zs_i.STATE  =  1
 AND ( (zs_i.item_ts  NOT IN  ('T06', 'Т106', 'T75', 'Т46', 'Т54', 'Т92', 'Т45', 'Т94', 'Т112', 'Т113', 'Т114','Т115', 'Т107')  AND  zso.ABC0  IN  ('A', 'B')) or (zs_i.item_ts = 'Т80' and zso.ABC0 in ('A') and (zs_item_g.ITEM_G2 IN ( '1828' , '1829') or  zs_item_g.ITEM_G4 in ('18260705')) ))
...
where
	...
	AND zs_item_g.ITEM_G2 NOT IN ( '5304' , '5308')
	AND ( (zs_i.item_ts  NOT IN  ('T06', 'Т106', 'T75', 'Т46', 'Т54', 'Т92', 'Т94', 'Т112', 'Т113', 'Т114', 'Т45', 'Т115', 'Т107')  AND  zso.ABC0  IN  ('A', 'B')) or (zs_i.item_ts = 'Т80' and zso.ABC0 IN ('A') and (zs_item_g.ITEM_G2 IN ( '1828' , '1829') or zs_item_g.ITEM_G4 in ('18260705'))))
