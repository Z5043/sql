...
LEFT JOIN (	SELECT  
  ...
  GROUP BY 
	...
	t.ITEM_NUM,
	t.imp,
	t.region) tvp1 on tvp1.item_num = n_m.item_num and date_format(n_m.push_date, "%Y-%m-%d" )=tvp1.dh  and tvp1.region=n_m.region
WHERE
