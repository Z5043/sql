Select 
  ...
  t1.ХСЗ,
  t1.Код_постав_5,
  t1.Название_постав_5,
  t1.Код_факт_постав_5,
  t1.Название_факт_постав_5,
  t2.Код_постав_16,
  t2.Название_постав_16,
  t2.Код_факт_постав_16,
  t2.Название_факт_постав_16,
  t1.Прод_менеджер,
...
(SELECT
  ...
  mvw_goods.HSZ ХСЗ,
  main_v.VENDOR_NUM Код_постав_5,
  main_v.VENDOR_NAME Название_постав_5,
  main_v.LEAD_TIME СП,
  main_v.TIME_GARANT ГВД,
  main_v.STOCK_CONTROL ЧКЗ,
  main_v.VEND_PARENT_NUM Код_факт_постав_5,
  main_v.VEND_PARENT_NAME Название_факт_постав_5,
...
( SELECT
  ...
  mvw.VENDOR_NUM Код_постав_16,
  mvw.VENDOR_NAME Название_постав_16,
  DECODE(NVL(mvw.vend_whse_status, 'D'), 'D', mvw_main_item_v.VEND_PARENT_NUM, mvw.VEND_PARENT_NUM) Код_факт_постав_16,
  DECODE(NVL(mvw.vend_whse_status, 'D'), 'D', mvw_main_item_v.VEND_PARENT_NAME, mvw.VEND_PARENT_NAME) Название_факт_постав_16,
  mvw.PROD_MANAGER МЛ,
